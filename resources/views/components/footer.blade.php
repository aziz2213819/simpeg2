{{-- FOOTER --}}
<footer id="footer" class="bg-zinc-950 text-zinc-400 py-16 px-4 sm:px-8 w-full overflow-hidden">
    <div class="max-w-7xl mx-auto grid md:grid-cols-4 gap-12">
        ...
        <div class="space-y-4">
            ...
            <ul class="space-y-2 text-sm w-full">
                <li class="break-words" style="word-break: break-word; hyphens: auto;">pengaduan@dlh.bangkalankab.go.id</li>
                <li>(031) 1234-5678</li>
